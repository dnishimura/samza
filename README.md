## What is Samza? [![Build Status](https://travis-ci.org/dnishimura/samza.svg?branch=master)](https://travis-ci.org/dnishimura/samza) [![Build Status](https://travis-ci.org/apache/samza.svg?branch=master)](https://travis-ci.org/apache/samza)
