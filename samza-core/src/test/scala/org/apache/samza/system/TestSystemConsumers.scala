...
class TestSystemConsumers {
  def testPollIntervalMs {
    ...
    consumers.register(systemStreamPartition0, new SamzaOffset("0"))
    consumers.register(systemStreamPartition1, new SamzaOffset("1234"))
    consumers.start
  ...
  def testBasicSystemConsumersFunctionality {
    ...
    consumers.register(systemStreamPartition, new SamzaOffset("0"))
    consumers.start
  ...
  def testThrowSystemConsumersExceptionWhenTheSystemDoesNotHaveConsumer() {
    ...
    try {
      consumers.register(systemStreamPartition2, new SamzaOffset("0"))
    } catch {
  ...
  def testDroppingMsgOrThrowExceptionWhenSerdeFails() {
    ...
    consumers2.register(systemStreamPartition, new SamzaOffset("0"))
    consumers2.start
    consumer(system).putBytesMessage
    consumer(system).putStringMessage
    consumer(system).putBytesMessage
  ...
  def testSystemConsumersShouldNotPollEndOfStreamSSPs {
    ...
    consumers.register(systemStreamPartition1, new SamzaOffset("0"))
    consumers.register(systemStreamPartition2, new SamzaOffset("0"))
    consumers.start
